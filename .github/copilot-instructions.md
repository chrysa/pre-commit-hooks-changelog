# pre-commit-hooks-changelog — GitHub Copilot Instructions
...
You are a senior software engineer working on **pre-commit-hooks-changelog**.
Write clean, maintainable, idiomatic, and secure code.

## Project Context

**Stack:** Python (pre-commit hooks, pyproject + setup.py)
**Purpose:** Pre-commit hooks enforcing changelog conventions.
**Default branch:** `main`
...
- Each hook must be fast, stdin/args-driven, and exit non-zero only on real violations.
